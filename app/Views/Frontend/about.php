        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3 text-[10px] font-black uppercase tracking-[0.3em]">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="text-slate-400">Profil Lembaga</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-white rounded-[3rem] shadow-sm border border-slate-200 overflow-hidden mb-10">
        <div class="grid grid-cols-1 lg:grid-cols-12">
            <div class="lg:col-span-5 bg-slate-50 p-12 lg:p-16 flex flex-col justify-center border-b lg:border-b-0 lg:border-r border-slate-200">
                ...
                <h2 class="text-3xl md:text-5xl font-black text-slate-900 mb-8 leading-tight text-center lg:text-left tracking-tight uppercase">Humas Sinjai</h2>
                ...
                <div class="flex items-center justify-center lg:justify-start gap-4 mt-4">
                    <a href="https://www.facebook.com/FP.KabupatenSinjai" target="_blank" class="w-12 h-12 bg-white border border-slate-200 text-slate-400 rounded-2xl flex items-center justify-center hover:bg-blue-800 hover:text-white transition-all shadow-sm"><i class="fab fa-fw fa-facebook-f text-sm"></i></a>
                    <a href="https://www.instagram.com/sinjaikab" target="_blank" class="w-12 h-12 bg-white border border-slate-200 text-slate-400 rounded-2xl flex items-center justify-center hover:bg-blue-800 hover:text-white transition-all shadow-sm"><i class="fab fa-fw fa-instagram text-sm"></i></a>
                    <a href="https://www.tiktok.com/@pemkabsinjai" target="_blank" class="w-12 h-12 bg-white border border-slate-200 text-slate-400 rounded-2xl flex items-center justify-center hover:bg-blue-800 hover:text-white transition-all shadow-sm"><i class="fab fa-fw fa-tiktok text-sm"></i></a>
                    <a href="https://www.youtube.com/@SINJAITV" target="_blank" class="w-12 h-12 bg-white border border-slate-200 text-slate-400 rounded-2xl flex items-center justify-center hover:bg-blue-800 hover:text-white transition-all shadow-sm"><i class="fab fa-fw fa-youtube text-sm"></i></a>
                    <a href="https://x.com/sinjaikab" target="_blank" class="w-12 h-12 bg-white border border-slate-200 text-slate-400 rounded-2xl flex items-center justify-center hover:bg-blue-800 hover:text-white transition-all shadow-sm"><i class="fab fa-fw fa-x-twitter text-sm"></i></a>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        foreach ($tugas as $t): ?>
                            <div class="flex items-start group">
                                ...
                                <div>
                                    <h4 class="font-black text-slate-900 text-sm mb-2 uppercase tracking-wide"><?= $t[0] ?></h4>
        ...
        foreach ($teams as $team): ?>
            <div class="bg-white text-center p-10 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-500 group">
                <div class="w-24 h-24 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-8 border-2 border-slate-100 group-hover:bg-blue-800 group-hover:border-blue-900 transition-all duration-500 shadow-inner">
                    <i class="fas fa-fw <?= $team[2] ?> text-slate-300 text-3xl group-hover:text-white transition-colors duration-500"></i>
                </div>
                <h3 class="text-xl font-black text-slate-900 mb-4 tracking-tight uppercase"><?= $team[0] ?></h3>
