...
<div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-8">
    <form action="<?= base_url('admin/posts') ?>" method="get" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div>
            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Kategori Berita</label>
        ...
        <div>
            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Status Publikasi</label>
            <select name="status" class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-800 outline-none">
                ...
                <option value="published" <?= ($filters['status'] ?? '') == 'published' ? 'selected' : '' ?>>Terbit</option>
        ...
        <div class="flex flex-col justify-end">
            <div class="flex items-center space-x-2">
                ...
                <a href="<?= base_url('admin/posts') ?>" class="px-4 py-2.5 bg-slate-100 text-slate-600 font-bold text-xs uppercase tracking-widest rounded-lg hover:bg-slate-200 transition-all border border-slate-200 text-center">Atur Ulang</a>
            </div>
        </div>
    </form>
</div>
