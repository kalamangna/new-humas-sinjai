...
<div class="max-w-5xl mx-auto">
    <div class="bg-white rounded-2xl sm:rounded-[2rem] shadow-sm border border-slate-200 overflow-hidden">
        <div class="px-5 sm:px-8 py-4 sm:py-6 bg-slate-50 border-b border-slate-200 flex items-center">
            ...
            <div>
                <h2 class="text-base sm:text-lg font-black text-slate-900 tracking-tight">Tambah Profil</h2>
                <p class="text-[9px] sm:text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">Lengkapi rincian profil baru</p>
            </div>
        </div>

        <div class="p-4 sm:p-8 md:p-12">
            <form action="<?= base_url('admin/profiles') ?>" method="post" enctype="multipart/form-data" class="space-y-8 sm:space-y-10 needs-validation" novalidate>
                <?= csrf_field() ?>
