    ...
    <footer class="bg-slate-950 text-slate-400 mt-20 border-t-8 border-blue-900">
        <div class="max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 items-start">
                ...
                <div class="text-center sm:text-left">
                    ...
                    <ul class="space-y-4 text-xs font-bold uppercase tracking-widest">
                        <li><a href="<?= base_url('/') ?>" class="hover:text-sky-400 flex items-center justify-center sm:justify-start transition-colors"><i class="fas fa-chevron-right text-[8px] mr-3 opacity-30 text-blue-500"></i>Beranda Utama</a></li>
                        <li><a href="<?= base_url('about') ?>" class="hover:text-sky-400 flex items-center justify-center sm:justify-start transition-colors"><i class="fas fa-chevron-right text-[8px] mr-3 opacity-30 text-blue-500"></i>Tentang Kami</a></li>
                        <li><a href="<?= base_url('contact') ?>" class="hover:text-sky-400 flex items-center justify-center sm:justify-start transition-colors"><i class="fas fa-chevron-right text-[8px] mr-3 opacity-30 text-blue-500"></i>Hubungi Kami</a></li>
                        <li><a href="<?= base_url('rss') ?>" class="hover:text-sky-400 flex items-center justify-center sm:justify-start transition-colors"><i class="fas fa-chevron-right text-[8px] mr-3 opacity-30 text-blue-500"></i>Layanan RSS</a></li>
                    </ul>
                </div>
                ...
                <div class="text-center sm:text-left">
                    ...
                    <ul class="space-y-6 text-sm font-medium">
                        <li class="flex items-center justify-center sm:justify-start">
                            <div class="bg-blue-900/50 p-2 rounded-lg mr-4 mt-1 flex-shrink-0"><i class="fas fa-map-marker-alt text-sky-500"></i></div>
                            <span class="leading-relaxed text-xs">Jl. Persatuan Raya No. 101, Balangnipa, Sinjai Utara, Sinjai</span>
                        </li>
                        <li class="flex items-center justify-center sm:justify-start">
                            <div class="bg-blue-900/50 p-2 rounded-lg mr-4 flex-shrink-0"><i class="fas fa-envelope text-sky-500"></i></div>
            ...
            <div class="border-t border-slate-900 mt-20 pt-10 flex flex-col md:flex-row justify-between items-center text-[10px] tracking-[0.2em] uppercase font-black">
                <p class="text-slate-600">&copy; <?= date('Y') ?> Humas Sinjai. Hak Cipta Dilindungi.</p>
            </div>
        </div>
    </footer>
