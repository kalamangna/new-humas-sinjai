        ...
        <div class="flex justify-between h-20">
            <div class="flex items-center">
                <a href="<?= base_url('/') ?>" class="flex-shrink-0 flex items-center">
                    <img src="<?= getOptimizedImageUrl(get_setting('site_logo', 'humas.png'), 320) ?>" alt="<?= esc(get_setting('site_name', 'Humas Sinjai')) ?>" width="200" height="40" class="h-10 w-auto" fetchpriority="high" decoding="async">
                </a>
