...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <article class="bg-white rounded-[3rem] shadow-sm border border-slate-200 overflow-hidden">
                <div class="p-8 md:p-16">
                    ...
                    <div class="text-center mb-16">
                        <div class="relative inline-block mb-10">
                            ...
                            <?php else : ?>
                                <div class="w-64 h-80 bg-slate-50 rounded-3xl shadow-inner border-4 border-dashed border-slate-200 flex items-center justify-center mx-auto">
                                    <i class="fas fa-user text-slate-200 text-8xl"></i>
                                </div>
                            <?php endif; ?>
                        ...
                        <?php if (!empty($profile['institution'])) : ?>
                            <div class="inline-flex items-center px-6 py-2 bg-blue-50 text-blue-800 rounded-full text-xs font-black uppercase tracking-widest border border-blue-100">
                                <i class="fas fa-landmark mr-3"></i><?= esc($profile['institution']) ?>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="border-t border-slate-100 pt-16">
                        <h3 class="text-xs font-black text-slate-900 uppercase tracking-[0.3em] mb-10 flex items-center justify-center lg:justify-start">
                ...
                <div class="bg-slate-50 p-8 border-t border-slate-100 text-center">
                    <a href="javascript:history.back()" class="inline-flex items-center text-xs font-black text-slate-500 hover:text-blue-800 uppercase tracking-widest transition-colors">
    ...
    <?php else : ?>
        <div class="text-center py-24 bg-white rounded-[3rem] border border-slate-200 shadow-sm px-8 max-w-2xl mx-auto">
            ...
            <h3 class="text-3xl font-black text-slate-900 mb-4 tracking-tight">Profil Tidak Tersedia</h3>
            <p class="text-slate-500 mb-12 leading-relaxed">Maaf, informasi detail untuk profil yang anda cari belum tersedia dalam sistem kami. Silakan kembali ke beranda utama.</p>
