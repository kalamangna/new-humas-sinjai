...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3 text-[10px] font-black uppercase tracking-[0.3em]">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="text-slate-400">Panduan Integrasi</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="text-center mb-20">
        ...
        <h1 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight">
            <i class="fas fa-puzzle-piece text-blue-800 mr-5 opacity-20"></i>Widget Berita
        </h1>
        <div class="mt-8 w-24 h-2 bg-blue-800 mx-auto rounded-full"></div>
        <p class="mt-8 text-lg text-slate-500 max-w-3xl mx-auto font-medium">Integrasikan berita terbaru Humas Sinjai langsung ke dalam situs web anda dengan mudah dan cepat.</p>
    </div>
    ...
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-[3rem] shadow-sm border border-slate-200 overflow-hidden">
            <div class="p-8 md:p-16">
                ...
                <!-- Installation -->
                <section class="mb-16">
                    <h2 class="text-xs font-black text-slate-900 uppercase tracking-[0.3em] mb-8 flex items-center">
                ...
                <section class="mb-16 space-y-12">
                    ...
                    <!-- Light Theme -->
                    <div>
                        <h3 class="text-sm font-black text-slate-400 uppercase tracking-widest mb-4">A. Light Theme (Default)</h3>
...
&lt;link rel="stylesheet" href="https://humas.sinjaikab.go.id/rss-widget/style.css"&gt;

&lt;!-- Kontainer Tampilan --&gt;
&lt;div id="humas-widget-light"&gt;&lt;/div&gt;

&lt;!-- Inisialisasi Script --&gt;
&lt;script src="https://humas.sinjaikab.go.id/rss-widget/widget.js"
    data-container="humas-widget-light"
    data-limit="5"
    data-theme="light"
    data-title="BERITA TERBARU SINJAI"&gt;
&lt;/script&gt;</code></pre>
                        </div>
                    </div>
                    ...
                    <!-- Dark Theme -->
                    <div>
                        <h3 class="text-sm font-black text-slate-400 uppercase tracking-widest mb-4">B. Dark Theme</h3>
                        <div class="relative group">
...
&lt;/script&gt;</code></pre>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-sm font-medium border-collapse">
                            ...
                            <tbody class="divide-y divide-slate-50">
                                <tr>
                                    <td class="py-6 pr-6 font-mono text-blue-800">data-container</td>
                                    <td class="py-6 pr-6"><span class="px-2 py-1 bg-red-50 text-red-600 rounded text-[9px] font-black uppercase tracking-widest">Wajib</span></td>
                                    <td class="py-6 text-slate-500 leading-relaxed">ID kontainer <code>&lt;div&gt;</code> tempat widget muncul.</td>
                                </tr>
                                <tr>
                                    <td class="py-6 pr-6 font-mono text-blue-800">data-limit</td>
                                    <td class="py-6 pr-6"><span class="px-2 py-1 bg-slate-50 text-slate-500 rounded text-[9px] font-black uppercase tracking-widest">Opsional</span></td>
                                    <td class="py-6 text-slate-500 leading-relaxed">Jumlah berita (1-10). Default: 5.</td>
                                </tr>
                                <tr>
                                    <td class="py-6 pr-6 font-mono text-blue-800">data-theme</td>
                                    <td class="py-6 pr-6"><span class="px-2 py-1 bg-slate-50 text-slate-500 rounded text-[9px] font-black uppercase tracking-widest">Opsional</span></td>
                                    <td class="py-6 text-slate-500 leading-relaxed">Gunakan <code>light</code> atau <code>dark</code>.</td>
                                </tr>
                                <tr>
                                    <td class="py-6 pr-6 font-mono text-blue-800">data-title</td>
                                    <td class="py-6 pr-6"><span class="px-2 py-1 bg-slate-50 text-slate-500 rounded text-[9px] font-black uppercase tracking-widest">Opsional</span></td>
                                    <td class="py-6 text-slate-500 leading-relaxed">Judul kustom yang tampil di bagian atas widget.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <!-- Live Preview -->
                <section>
                    <h2 class="text-xs font-black text-slate-900 uppercase tracking-[0.3em] mb-12 flex items-center justify-center">
                        <span class="w-10 h-0.5 bg-slate-200 mr-4"></span>Pratinjau Langsung<span class="w-10 h-0.5 bg-slate-200 ml-4"></span>
                    </h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                        <div class="space-y-6">
                            <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">Light Theme Preview</p>
                            <div id="rss-widget-preview-light" class="shadow-2xl rounded-2xl overflow-hidden ring-1 ring-slate-100"></div>
                        </div>
                        <div class="space-y-6">
                            <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest text-center">Dark Theme Preview</p>
                            <div id="rss-widget-preview-dark" class="shadow-2xl rounded-2xl overflow-hidden ring-1 ring-slate-800"></div>
                        </div>
                    </div>
                </section>
            </div>
