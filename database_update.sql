...
('about_tasks', '[["Pengelolaan Informasi", "Mengumpulkan, mengolah, dan menyebarluaskan informasi resmi pemerintah."],["Media Relations", "Menjalin hubungan profesional dengan media massa nasional dan lokal."],["Publikasi Daerah", "Mempublikasikan berbagai kegiatan strategis and prestasi pemerintah daerah."],["Dokumentasi Visual", "Mendokumentasikan seluruh kegiatan pemerintah melalui foto and video profesional."],["Manajemen Isu", "Menangani isu publik and menyampaikan klarifikasi resmi demi reputasi daerah."]]', 'about', 'json', 'Tugas Pokok & Fungsi (JSON)', NOW(), NOW()),
